...
- **Image and Video Upscaling — [ComfyUI Flux Regen](https://github.com/komo-248/ComfyUI-Flux-Regenerative-Upscale)** / [FFmpeg + Upscayl](https://github.com/komo-248/Video-Upscaling-FFmpeg-Upscayl) `post-education` – ML-based super-resolution and diffusion-based regenerative upscaling. FFmpeg frame extraction pipeline and Real-ESRGAN upscaling; ComfyUI workflow using FLUX.1-fill-dev with a layered signal processing chain (Canny, FBCNN, bilateral filtering) for mask construction and inpainting.
