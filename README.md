...
- **[Klipper Configuration](https://github.com/komo-248/Klipper-Installation-Process-and-Methodology/tree/main)** `post-education` – Full Klipper installation and tuning on a Sovol SV05 — PID tuning, input shaping with ADXL345, pressure advance calibration, and open-loop extruder control on Linux SBC.
...
- **[Lego SW:TCS ReShade](https://github.com/komo-248/ReShade-LSWTCS)** `post-education` – Layered post-processing pipeline using ReShade — CAS sharpening, HDR expansion, directional AA, Glamarye GI tone mapping, and MXAO ambient occlusion staged in deliberate signal processing order.
...
- **TradingView Indicators** `college / post-education` – Built and back-tested algorithmic trading strategies in PineScript — signal generation, entry/exit logic, and quantitative performance evaluation.
